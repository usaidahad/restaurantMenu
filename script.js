const menuItems = [
  {
    name: "Burger",
    price: 9.99,
    imageLink: "https://via.placeholder.com/150?text=Burger",
  },
  {
    name: "Pizza",
    price: 12.5,
    imageLink: "https://via.placeholder.com/150?text=Pizza",
  },
  {
    name: "Salad",
    price: 8.75,
    imageLink: "https://via.placeholder.com/150?text=Salad",
  },
  {
    name: "Pasta",
    price: 11.25,
    imageLink: "https://via.placeholder.com/150?text=Pasta",
  },
  {
    name: "Fries",
    price: 5.0,
    imageLink: "https://via.placeholder.com/150?text=Fries",
  },
  {
    name: "Soda",
    price: 2.5,
    imageLink: "https://via.placeholder.com/150?text=Soda",
  },
];
...
function updateOrderDisplay() {
  ...
  for (const itemName in itemCounts) {
    ...
    itemText.textContent = `${item.name} x${count} - $${(
      item.price * count
    ).toFixed(2)}`;
...
function updateCheckoutDisplay() {
  ...
  for (const itemName in itemCounts) {
    ...
    const listItem = document.createElement("li");
    listItem.textContent = `${item.name} x${count} - $${(
      item.price * count
    ).toFixed(2)}`;
...
document.getElementById("checkout-form").addEventListener("submit", event => {
  ...
  const confirmationOrderList = document.getElementById(
  ...
  for (const itemName in itemCounts) {
    ...
    const count = itemCounts[itemName];
    const listItem = document.createElement("li");
    listItem.innerHTML = `<span>${item.name} x${count}</span><span>$${(
      item.price * count
    ).toFixed(2)}</span>`;
  ...
  ).textContent = `Total: $${confirmationTotal.toFixed(2)}`;
